...
const replaceWords = (str) => {
    // write your code here
    let arrSpilt = str.split(" ");
    for (let index = 0; index < arrSpilt.length; index++) {

        if (arrSpilt.indexOf('I') != -1){
            (arrSpilt.splice(arrSpilt.indexOf('I'),1,'We'));
        }
        if (arrSpilt.indexOf('am') != -1){
            (arrSpilt.splice(arrSpilt.indexOf('am'),1,'are'));
        }
        if (arrSpilt.indexOf('was') != -1){
            (arrSpilt.splice(arrSpilt.indexOf('was'),1,'were')); 
        }
    }
    return arrSpilt.join(" ");
}
// -------------------------------------------------------------------------------------------------------
...
const arrToStr = (arr) => {
    // write your code here
    for (let index = 4; index < arr.length; index+=5) arr.splice(index+=1, 0, ","); return arr.join(" ").replaceAll(" ,", ",");
}
// -------------------------------------------------------------------------------------------------------
// 
// -------------------------------------------------------------------------------------------------------
